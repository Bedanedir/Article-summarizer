...
const [allArticle, setAllArtcile] = useState([])
...
const articleFromLocalStorage = JSON.parse(
  localStorage.getItem('artcile')
)
if(articleFromLocalStorage) {
  setAllArtcile(articleFromLocalStorage)
}
...
const handleSubmit = async (e) => {
  ...
  if(data?.summary){
    ...
    setArtcile(newArticle)
    setAllArtcile(updatedAllArticles)
    
      localStorage.setItem('artcile', 
